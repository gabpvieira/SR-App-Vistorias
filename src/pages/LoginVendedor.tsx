...
export default function LoginVendedor() {
  ...
  return (
    <>
      <Helmet>
        <title>Login Vendedor - SR Caminhões</title>
        <meta name="description" content="Acesso para vendedores da SR Caminhões." />
      </Helmet>
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 shadow-xl">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Acesso Vendedor</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="vendedor@srcaminhoes.com.br"
                  value={email}
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm">
            ...
            <Link to="/login/gerente" className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
              Acesso Gerente
            </Link>
          </div>
        </div>
