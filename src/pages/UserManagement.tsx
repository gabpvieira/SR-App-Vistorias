                ...
                <table className="w-full">
                  <thead className="bg-muted/50 border-b border-border">
                    <tr>
                      ...
                      <th className="text-left px-4 py-3 text-sm font-semibold text-foreground hidden md:table-cell">E-mail</th>
                        ...
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground md:hidden">{u.email}</p>
                            </div>
                          </div>
                        </td>
